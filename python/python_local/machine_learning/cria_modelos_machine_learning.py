...
def ClassTrainEval(spark,classifier,features,classes,train,test):
...
#                              .addGrid(classifier.maxDepth, [2, 5, 10, 20, 30]) \
    ...
    if Mtype in("LinearSVC","GBTClassifier") and classes != 2:
        ...
        registrar_log( "Classificador: " + Mtype + " / Acurácia: " + str(accuracy))
        Mtype = [Mtype]
        score = [str(accuracy)]
...
def cria_modelos_machine_learning (spark,HTFfeaturizedData,TFIDFfeaturizedData,W2VfeaturizedData):
...
#               ,MultilayerPerceptronClassifier()
    ...
    for featureDF in featureDF_list:
        ...
        registrar_log( featureDF.name + " Resultados: ")
        ...
        for classifier in classifiers:
            new_result = ClassTrainEval(spark,classifier,features,classes,train,test)
